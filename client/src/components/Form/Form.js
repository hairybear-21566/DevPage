...
const Form = ({setCurrentId,currentId}) => {
    const [postData, setPostData] = useState({  creator: '',price:'', title: '', desc: '', supply: '', selectedFile: '', mintInfo:'' });
    ...
    const clear = () => {
        setCurrentId(null)
        setPostData({ creator: '', price:'',title: '', desc: '', supply: '', selectedFile: '', mintInfo:'' });
    };
/*title: String,
desc: String,
    creator: String,
